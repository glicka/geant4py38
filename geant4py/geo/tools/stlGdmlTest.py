...
def main(outputFile, inputFile, materials=None):
    __is_help__()
    ...
    if ".stl" in outputFile:
    	__print__('Please provide output/gdml file name! see  "python %s -h" for more details')
    	raise SystemExit
    creat_gdml_bundle(outputFile.split('.gdml')[0],inputFile)
