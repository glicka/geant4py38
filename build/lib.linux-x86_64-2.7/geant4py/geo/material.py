...
def customMaterial():
    ...
    # Setup
    name = "CustomName"
    components = {"Atom1": relativeAbundance1, "Atom2": relativeAbundance2} #*1e22
...
def Water():
    '''Define air'''
    return g4.gNistManager.FindOrBuildMaterial(g4.G4String("G4_WATER"))
...
def PMMA(voxNum):
    ...
    name = "Polymethyl Methacralate (Lucide/Plexiglass)_{}".format(voxNum)
